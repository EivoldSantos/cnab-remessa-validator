...
/** Segmento Q CNAB240 BB — ACBrBancoBrasil.GerarRegistroTransacao240 */
export const BB_C240_SEGMENTO_Q: RecordSpec = {
  id: 'cobBancoDoBrasil-c240-segmento-q',
  layout: 'c240',
  recordType: '3Q',
  label: 'Segmento Q BB',
  lineLength: 240,
  ...
  fields: [
    ...
    { id: 'cep', label: 'CEP', start: 129, end: 136, type: 'numeric', issueCode: 'F240_BB_CEP' },
